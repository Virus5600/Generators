...
/***/ "./src/js/libs/bootstrap-components/popover.js":
/*!*****************************************************!*\
  !*** ./src/js/libs/bootstrap-components/popover.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var Popover = __webpack_require__(/*! bootstrap/js/dist/popover */ "./node_modules/bootstrap/js/dist/popover.js");
...
/* harmony export */ });
/* harmony import */ var _libs_bootstrap_components_popover_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../../libs/bootstrap-components/popover.js */ "./src/js/libs/bootstrap-components/popover.js");
...
var Tutorial = /*#__PURE__*/function () {
  ...
  _createClass(Tutorial, null, [{
    ...
    key: "end",
    value: function end() {
      document.querySelector(_classStaticPrivateFieldSpecGet(Tutorial, Tutorial, _previous)).removeAttribute("data-vs5-tutorial-target");
      _classStaticPrivateFieldSpecSet(Tutorial, Tutorial, _index, null);
      _classStaticPrivateFieldSpecSet(Tutorial, Tutorial, _previous, 0);
...
function _iterate2(index) {
  ...
  if (_classStaticPrivateFieldSpecGet(Tutorial, Tutorial, _previous) !== null && ((_classStaticPrivateFi = _classStaticPrivateFieldSpecGet(Tutorial, Tutorial, _previous)) === null || _classStaticPrivateFi === void 0 ? void 0 : _classStaticPrivateFi.length) > 0) {
    var _classStaticPrivateFi2;
    (_classStaticPrivateFi2 = _classStaticPrivateFieldSpecGet(Tutorial, Tutorial, _previous).getElementById("vs5-tutorial-overlay")) === null || _classStaticPrivateFi2 === void 0 ? void 0 : _classStaticPrivateFi2.remove();
  }
  ...
  var popover = new _libs_bootstrap_components_popover_js__WEBPACK_IMPORTED_MODULE_0__["default"](key, {});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("app-category").each(function (k, v) {
    ...
    obj.find("sub-application").each(function (i, e) {
      var _data$link, _data$img, _data$title, _data$title2, _data$desc;
      var data = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e).data();
      applications += "\n\t\t\t<a class=\"app\" href=\"".concat((_data$link = data.link) !== null && _data$link !== void 0 ? _data$link : "/", "\">\n\t\t\t\t<img src=\"").concat((_data$img = data.img) !== null && _data$img !== void 0 ? _data$img : "resources/favicon.png", "\" alt=\"").concat((_data$title = data.title) !== null && _data$title !== void 0 ? _data$title : "Sub-Application", "\" class=\"app-thumbnail\"/>\n\n\t\t\t\t<div class=\"app-title-container\">\n\t\t\t\t\t<span class=\"app-title\">\n\t\t\t\t\t\t").concat((_data$title2 = data.title) !== null && _data$title2 !== void 0 ? _data$title2 : "Sub-Application", "\n\t\t\t\t\t\t<small class=\"app-description\">").concat((_data$desc = data.desc) !== null && _data$desc !== void 0 ? _data$desc : "A sub-application", "</small>\n\t\t\t\t\t</span>\n\t\t\t\t</div>\n\t\t\t</a>\n\t\t\t");
    });
